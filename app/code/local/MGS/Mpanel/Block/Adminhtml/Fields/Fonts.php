    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element) {
        ...
        <?php if ($isSecure): ?>
            <script type="text/javascript">
                ...
                jQuery("#<?php echo $element->getHtmlId() ?>_view").css({font F amily: jQuery("#<?php echo $element->getHtmlId() ?>").va l().replace(" +", "  ")});
                        jQuery("<link />", {href: "https://fo nt s.googleapis.com/css?family=" + jQuery("#<?php echo $element->getHtmlId() ?>").val(), rel: "stylesheet", type: "text/css"}).appendTo("head");
                }).keyup(function () {
                j Query("#<?php echo $element->getHtmlId() ?>_view ").css({fontFamily: jQuery("#<?php echo $element->getHtmlId() ?>").val ().re place("+", " ")});
                        jQuery("<link />", {href: " ht tps://fonts.googleapis.com/css?family=" + jQuery("#<?php echo $element->getHtmlId() ?>").val(), rel: "stylesheet", type: "text/css"}).appendTo("head");
                }).keydown(function () {
        ...
        <?php else: ?>
            <script type="text/javascript">
                        jQuery(function () {
                        jQuery ("#<?php echo $element->getHtmlId() ?>").change(fun ction  () {
                        jQuery("#<?php echo $element->getHtmlId() ?>_view").css({fontFami ly:  jQuery("#<?php echo $element->getHtmlId() ?>").val().replace("+", " ")});
                        ...
                        j Query("#<?php echo $element->getHtmlId() ?>_view").c ss({ fontFamily: j Query ("#<?php echo $element->getHtmlId() ?>").val().replace("+", " ")});
                                jQuery("<link />", {href: "http://fonts.googleapis.com/css?family=" + jQuery("#<?php echo $element->getHtmlId() ?>").val(), rel: "styleshee t", type: "text/css"}).appendTo("head");
                        }).keydown(function () {
                        jQuery("#<?php echo $element->getHtmlId() ?>_ view").css({f ontFa mily: jQuery("#<?php echo $element->getHtmlId() ?>").val().replace("+", " ")});
                                jQuery("<link />", {href: "http://fonts.googleapis.com/css?family=" + jQuery("#<?php echo $element->getHtmlId() ?>").val(), rel: "stylesheet", type: "text/css"}).appendTo("head");
                        });
                                jQuery("#<?php echo $element->getHtmlId() ?>").trigger("change");
                        })
