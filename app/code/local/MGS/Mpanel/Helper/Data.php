...
class MGS_Mpanel_Helper_Data extends MGS_Mgscore_Helper_Data {
    ...
    public function getThemeSettings() {
        $setting = array(
            ...
            'grayscale_color' => Mage::getStoreConfig('mpanel/contact/grayscale_color'),
    ...
    public function getStaticBlocksByStore($store) {
        $collection = Mage::getModel('cms/block')->getCollection()->addStoreFilter($store, true);
    ...
    public function getColorAccept($type, $color = NULL) {
        $dir = Mage::getBaseDir() . '/skin/frontend/mgstheme/default/asset/colour/';
        $html = '';
        if (is_dir($dir)) {
            if ($dh = opendir($dir)) {
                $html .= '<ul>';
                ...
                foreach ($files as $file) {
                    ...
                    if (isset($file_parts['extension']) && $file_parts['extension'] == 'png') {
                        ...
                        $html .= '>';
                        $html .= '<img src="' . Mage::getBaseUrl(Mage_Core_Model_Store::URL_TYPE_SKIN) . 'frontend/mgstheme/default/asset/colour/' . $file . '" alt=""/>';
                        $html .= '</a>';
                        $html .= '</li>';
                    }
                }
    ...
    public function getHeaderColorSetting() {
        $setting = array(
            ...
            '#nav_container #mainMenu a.level0, .nav-container .menu-mobile .menu-effect ul.mega-nav .links-menu a' => array(
                'color' => Mage::getStoreConfig('theme_color/header/menu_link_color')
            ),
            '#nav_container #mainMenu a.level0:hover, .nav-container .menu-mobile .menu-effect ul.mega-nav .links-menu a:hover' => array(
    ...
    public function getFooterColorSetting() {
        $setting = array(
			...
			'.top-footer .block-subscribe label' => array(
                'color' => Mage::getStoreConfig('theme_color/footer/top_text_color'),
            ),
            '.top-footer a' => array(
			...
			'.top-footer .block-socials a' => array(
                'border-color' => Mage::getStoreConfig('theme_color/footer/top_icon_color')
            ),
            // Middle Footer
            '.middle-footer' => array(
    ...
    public function getMainColorSetting() {
        $setting = array(
            ...
            '.btn-default:hover,.btn-default:focus,.icon-links li:hover' => array(
            ...
            '.btn-primary:hover,.btn-primary:focus' => array(
            ...
            '.btn-secondary:hover,.btn-secondary:focus' => array(
			...
			/* Product detail */
            '.product-view .nav-tabs > li.active > a,.image-media .magnifier .buttons,
			 .hover-bottom .product-content:hover .product-desc,
			 .product-tabs .tab-item h3.active,
			 .mobile-header .nav-container .menu,
			 .nav-container .block-title strong, .v-menu-title,
			 .nav-container .btn-menu,
			 .title-page::after, .block-title::after,
			 .button-search .button,
			 .header-v1 .search-mini-form .form-search,
			 .tabs-container .nav-tabs > li.active > a,
			 .tabs-container .nav-tabs > li:hover > a,
			 .nav-container .nav-category ul li::after,
			 .nav-container .nav-category ul li::after,
			 .nav-container ul li .block.nav-category ul li.level1 > a::after,
			 .nav-footer li::before, .nav-block li.level0 a::before,
			 #narrow-by-list .price .ui-slider-handle,
			 .my-account .box .box-title, .my-account .info-box .box-title, 
			 .my-account .order-history .pager, .my-account .review-history .pager, 
			 ...
			 .form-search select>option:hover, .form-search select>option:focus,
			 .title-categories a.link-category:hover' => array(
                'background-color' => Mage::getStoreConfig('theme_color/main/default_color')
			),
			'.product-view .tabbable .tab-content,.product-view .nav-tabs > li.active > a,
			 .catalog-product-view .products-carousel .owl-buttons .owl-prev button:hover,
			 .catalog-product-view .products-carousel .owl-buttons .owl-next button:hover,
			 .nav-container .top-cart .cart-content,
			 .title-categories p.title span::after, .products-tabs .tab-menu li.active a span::after,
			 .category-tabs .tabs-container .tab-menu li.active a, .tabs-container .nav-tabs > li:hover > a,
			 ...
			 .block-cart-header .style-dropdow-menu,.title-categories a.link-category:hover,
			 #newsletter-popup .newsletter-popup > p:first-child:after,
			 .block-popup-top, .block-tags .block-content ul li a:hover' => array(
				'border-color' => Mage::getStoreConfig('theme_color/main/default_color')
			),
			'#maincontent a:hover,#maincontent a:focus,.footer-bottom a:hover,
			 #header-v1 ul.mega-nav .level0 a:hover,#header-v1 ul.mega-nav .level0 a:focus,#header-v1 ul.mega-nav .parent:hover > span a,
			 .catalog-product-view .products-carousel .owl-buttons .owl-prev button:hover,
			 .catalog-product-view .products-carousel .owl-buttons .owl-next button:hover,
			 .my-account-main a,.title-categories p.title,
			 .menu-category li:hover a, .menu-category li:hover a .icon,
			 #newsletter-popup .mfp-close,
			 .shopping-cart .cart-collaterals .checkout-types li a,
			 .block-content ul li, .block-content ul li:hover > a,
			 .copy-right address a:hover .icon-card li a:hover, .menu-footer li a:hover, .menu-footer li:hover a,
			 .owl-carousel .icon-wrap:hover,
			 .block-tags .block-content ul li a:hover' => array(
				'color' => Mage::getStoreConfig('theme_color/main/default_color')
			),
			
			'#maincontent a, .my-account-main a, #maincontent ul li a' => array(
                'color' => Mage::getStoreConfig('theme_color/main/link_color'),
            ),
            '#maincontent a:hover,#maincontent a:focus, .my-account-main a:hover, #maincontent ul li a:hover' => array(
                'color' => Mage::getStoreConfig('theme_color/main/link_hover_color')
            ),
        );
        $setting = array_filter($setting);
        return $setting;
